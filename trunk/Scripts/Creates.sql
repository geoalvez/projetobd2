...
DROP TABLE DEPENDENTES_STB FORCE;
DROP TABLE EMPRESTIMOS_STB FORCE;
DROP TABLE RESERVAS_STB FORCE;
DROP TABLE OPINIOES_STB FORCE;
DROP TABLE PROFISSIONAIS_STB FORCE;
--
--	CREATE TABLES
--
