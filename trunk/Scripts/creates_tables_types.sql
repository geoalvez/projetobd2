...
NESTED TABLE DEPENDENTES STORE AS DEPENDENTES_TB,
NESTED TABLE EMPRESTIMOS STORE AS EMPRESTIMOS_TB,
NESTED TABLE RESERVAS STORE AS RESERVAS_TB,
NESTED TABLE OPINIOES STORE AS OPINIOES_TB;
--
