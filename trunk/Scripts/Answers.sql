...
COMO NAO EXISTEM ALGORITMOS PARA MAPEAMENTO DE ESQUEMA R PRA OR OU DE
UML PARA OR, MODELAMOS EMPRESTIMOS COMO NESTED TABLE. COM ISSO,
NAO HA A CRIACAO DE TRIGGERS PARA NESTED TABLES. PORTANTO, NAO FOI POSSIVEL A CRIACAO DO TRIGGER
...
--11
 ...
 ALTER TYPE FORNECEDOR_TY
    DROP MEMBER PROCEDURE ENGLISHCATEGORY
    (SELF IN OUT NOCOPY FORNECEDOR_TY)
	CASCADE;

ALTER TYPE FORNECEDOR_TY
    ADD MEMBER PROCEDURE ENGLISHCATEGORY 
	(SELF IN OUT NOCOPY  FORNECEDOR_TY)
	CASCADE;



CREATE OR REPLACE TYPE BODY FORNECEDOR_TY IS
    MEMBER PROCEDURE ENGLISHCATEGORY
	(
		SELF IN OUT NOCOPY FORNECEDOR_TY,
	)   AS
	CURSOR C IS
