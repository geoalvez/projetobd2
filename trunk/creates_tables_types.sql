...
create table DEPENDENTES_TB of DEPENDENTE_TY;
create table EMPRESTIMOS_TB of EMPRESTIMO_TY;
create table RESERVAS_TB of RESERVA_TY;
create table OPINIOES_TB of OPINIAO_TY;
