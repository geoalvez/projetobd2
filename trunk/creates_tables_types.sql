...
/
CREATE TYPE DEPENDENTES_NT AS TABLE OF REF DEPENDENTE_TY;
/
...
/
CREATE TYPE EMPRESTIMOS_NT AS TABLE OF REF EMPRESTIMO_TY;
/
...
/
CREATE TYPE RESERVAS_NT AS TABLE OF REF RESERVA_TY;
/
...
/
CREATE TYPE OPINIOES_NT AS TABLE OF REF OPINIAO_TY;
/
...
/
CREATE TYPE PROFISSIONAIS_NT AS TABLE OF REF PROFISSIONAL_TY;
/
...
--
--
create table CLIENTES_TB of CLIENTE_TY (PRIMARY KEY (CODIGO));

CREATE TABLE CLIENTES_TB_INFORM
(
...
NESTED TABLE STORE AS EMPRESTIMOS_STB,
NESTED TABLE RESERVAS STORE AS RESERVAS_STB,
NESTED TABLE OPINIOES STORE AS OPINIOES_STB;
--

create table FILMES_TB of FILME_TY (PRIMARY KEY (CODIGO));
create table DEPENDENTES_TB of DEPENDENTE_TY(PRIMARY KEY (CODIGO));
create table EMPRESTIMOS_TB of EMPRESTIMO_TY(PRIMARY KEY (CODIGO));
create table RESERVAS_TB of RESERVA_TY(PRIMARY KEY (CODIGO));
create table OPINIOES_TB of OPINIAO_TY(PRIMARY KEY (CODIGO));
create table PROFISSIONAIS_TB OF PROFISSIONAL_TY(PRIMARY KEY (CODIGO));
